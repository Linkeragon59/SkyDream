...
void CXX_API(const char* model_path, const char* execution_provider) {
  ...
  while (true) {
    ...
    const size_t prompt_tokens_length = sequences->SequenceCount(0);
    const size_t new_tokens_length = generator->GetSequenceCount(0) - prompt_tokens_length;
    timing.LogTime(prompt_tokens_length, new_tokens_length);
